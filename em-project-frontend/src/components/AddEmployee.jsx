...
const AddEmployee = () => {
    ...
    <div className='max-w-xl mx-40 bg-slate-800 my-20 rounded shadow py-4 px-8'>
        ...
        <div className="flex my-4 space-x-4 px-37">
            <button onClick={saveEmployee} className='bg-green-400 hover:bg-green-700 py-2 px-2 rounded'>Save</button>
            <button onClick={reset} className='bg-blue-400 hover:bg-blue-700 py-2 px-2 rounded'>Clear</button>
